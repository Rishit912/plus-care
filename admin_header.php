			...
			<nav class="navbar navbar-default">
				...
				<div class="collapse navbar-collapse nav-wil" id="bs-example-navbar-collapse-1">
					...
					<ul id="m_nav_list" class="m_nav menu__list">
						...
						<li class="m_nav_item menu__item" id="moble_nav_item_2"> <a href="department_view_admin.php" class="menu__link"> Department </a> </li>		
						<li class="m_nav_item menu__item" id="moble_nav_item_4"> <a href="doctor_view_admin.php" class="menu__link">Doctor  </a> </li>
						<li class="m_nav_item menu__item " id="moble_nav_item_5"> <a href="gallery_view_admin.php" class="menu__link">Gallery</a> </li>
						<li class="m_nav_item menu__item " id="moble_nav_item_5"> <a href="schedule_doctor_view_admin.php" class="menu__link">Schedule</a> </li>
						<li class="m_nav_item menu__item" id="moble_nav_item_6"> <a href="appointment_view_admi.php" class="menu__link"> Appointment </a> </li>
						<li class="m_nav_item menu__item" id="m_nav_item_1"> <a href="feedback_view_admin.php" class="menu__link"> Review </a></li>
